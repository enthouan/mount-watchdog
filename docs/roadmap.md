...
- One Bash 3.2-compatible maintained runtime, separate read-only status path, shared defaults, plist template, transactional installer, conservative uninstaller, and thin installed wrappers replace the independent historical copies.
